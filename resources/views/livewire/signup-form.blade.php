  ...
  <div class="registro container  mb-2 mx-auto" id="registro">
    ...
    <div class="registro--seleccion bg-white rounded-lg shadow-lg w-11/12 lg:w-1/2 max-w-screen-xl mb-6 mx-auto py-2">
        ...
        <div class="tipo-cuenta flex justify-center">
            <input wire:model="type" type="radio" value="1" id="employer" name="tipoCuenta">
            <label class="radio text-sm pt-1" for="employer"> Busco profesionista </label>

            <input wire:model="type" type="radio" value="2" id="expert" name="tipoCuenta" >
            <label class="radio text-sm pt-1" for="expert"> Soy un experto </label>
        </div>
        ...
        <p class=" text-xs text-red-900 ">{{ $errors->first('password') }}</p>
          <span class="flex flex-col justify-center items-center w-full my-2 pl-4 pr-3">
              <p class=" text-sm leading-5 font-semibold mb-2">Al hacer clic, indicas que estas de acuerdo con nuestros <a class=" text-gray-400 " href="#">terminos y condiciones</a>.</p>
